...
To install the shared library and the development files into `$HOME/.local`, paste the following into a terminal and press <kbd>ENTER</kbd>:
...
Paste the following into a terminal and press <kbd>ENTER</kbd>:
